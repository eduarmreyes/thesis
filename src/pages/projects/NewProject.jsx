...
class NewProjectAdmin extends Component {
  ...
  getDataInit(chart) { this.setState({ initChart: chart }); }
      	...
      	<div className="border-bottom side-margins box">
	      	...
	      	<Form>
	      	  <FormGroup row className="align-items-center">
	      	    <Label for="project-name" sm={2}>Nombre</Label>
	      	    <Col sm={10}>
	      	      <Input type="text" name="project-name" id="project-name" placeholder="Nombre del Proyecto" />
	      	    </Col>
	      	  </FormGroup>
	      	  <FormGroup row className="align-items-center">
	      	    <Label for="project-coordinador" sm={2}>Coordinador</Label>
	      	    <Col sm={10}>
	      	      <Input type="text" name="project-coordinador" id="project-coordinador" placeholder="Coordinador del Proyecto" />
	      	    </Col>
	      	  </FormGroup>
	      	  <FormGroup row className="align-items-center">
	      	    <Label for="project-responsible-team" sm={2}>Equipo Responsable</Label>
	      	    <Col sm={10}>
	      	      <Input type="select" name="select" id="project-responsible-team" />
	      	    </Col>
	      	  </FormGroup>
	      	  <FormGroup row className="align-items-center">
	      	    <Label for="project-total-people" sm={2}>Población Total</Label>
	      	    <Col sm={10}>
	      	      <Input type="text" name="project-total-people" id="project-total-people" placeholder="Población Total" />
	      	    </Col>
	      	  </FormGroup>
	      	  <FormGroup row className="align-items-center">
	      	    <Label for="project-men-percentage" sm={2}>Porcentaje de Hombres</Label>
	      	    <Col sm={10}>
	      	      <Input type="text" name="project-men-percentage" id="project-men-percentage" placeholder="Porcentaje de Hombres en plan" />
	      	    </Col>
	      	  </FormGroup>
	      	  <FormGroup row className="align-items-center">
	      	    <Label for="project-women-percentage" sm={2}>Porcentaje de Mujeres</Label>
	      	    <Col sm={10}>
	      	      <Input type="text" name="project-women-percentage" id="project-women-percentage" placeholder="Porcentaje de Mujeres en plan" />
	      	    </Col>
	      	  </FormGroup>
	      	  <FormGroup row className="align-items-center">
	      	    <Label for="project-geographic-area" sm={2}>Área Geográfica</Label>
	      	    <Col sm={10}>
	      	      <Input type="textarea" name="project-geographic-area" id="project-geographic-area" />
	      	    </Col>
	      	  </FormGroup>
	      	  <FormGroup row className="align-items-center">
	      	    <Label for="project-presentation" sm={2}>Presentación</Label>
	      	    <Col sm={10}>
	      	      <Input type="textarea" name="project-presentation" id="project-presentation" />
	      	    </Col>
	      	  </FormGroup>
	      	  <FormGroup row className="align-items-center">
	      	    <Label for="project-background" sm={2}>Antecedentes</Label>
	      	    <Col sm={10}>
	      	      <Input type="textarea" name="project-background" id="project-background" />
	      	    </Col>
	      	  </FormGroup>
	      	  <FormGroup row className="align-items-center">
	      	    <Label for="project-justification" sm={2}>Justificación</Label>
	      	    <Col sm={10}>
	      	      <Input type="textarea" name="project-justification" id="project-justification" />
	      	    </Col>
	      	  </FormGroup>
	      	  <FormGroup row className="align-items-center">
	      	    <Label for="project-faculty" sm={2}>Facultad</Label>
	      	    <Col sm={10}>
