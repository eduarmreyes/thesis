			...
			<div className="flex-container">
				<div className="col-5">
					<div className="register--information">
						...
						<p className="t-center blue">Paso 4: Validación de Información</p>
						<ul className="register--steps-number">
							...
							<li className="register-step"><a className="register-step--link active" to="empasocuatro">4</a></li>
				...
				<div className="col-7 register-form--step-1">
					<form name="step-four" className="register--form" onSubmit={this.onSubmit}>
						<div className="register--form-d-flex">
							<div className="register--form--wrapper">
								<label className="register--label" htmlFor="personal_references">Referencia # 1</label>
						...
						<div className="register--form-d-flex">
							<div className="register--form--wrapper">
								<label className="register--label" htmlFor="personal_references2">Referencia # 2</label>
						...
						<div className="register--form-d-flex">
							<div className="register--form--wrapper">
								...
								<input className="custom-file-input" type="file" name="dui" id="dui" required onChange={this.onChange} />
							</div>
						</div>
						<div className="register--form-d-flex">
							<div className="register--form--wrapper">
						...
						<div className="register--form-d-flex">
							<div className="register--form--wrapper">
								...
								<label className="register--label" htmlFor="bank_reference">
									...
									{
										(this.state.bank_reference && this.state.bank_reference !== "") ?
										<FaCheckCircle /> :
										''
									}
								</label>
						...
						<div className="register--form-d-flex">
							<div className="register--form--wrapper">
								<label className="register--label" htmlFor="family_reference">
									...
									{
										(this.state.family_reference && this.state.family_reference !== "") ?
										<FaCheckCircle /> :
										''
									}
								</label>
						...
						<div className="register--form-d-flex">
							<div className="register--form--wrapper">
								<label className="register--label" htmlFor="record_of_payments" data-tip="Estado de cuenta bancario, declaración de renta reciente, documento compra-venta o préstamo, etc">
									...
									{
										(this.state.record_of_payments && this.state.record_of_payments_file_name !== "") ?
										<FaCheckCircle /> :
										''
									}
								</label>
						...
						<div className="register--form-d-flex">
							<div className="register--form--buttons-right">
								<Link to="/empasotres" className="btn btn-back">Atrás</Link>
							</div>
							<div className="register--form--as">
								...
								<Link to="/empasocinco" className={`btn btn-next ${this.state.step >= this.state.active_step ? "disabled-link" : ""}`}>Siguiente</Link>
							</div>
						</div>
					</form>
				</div>
