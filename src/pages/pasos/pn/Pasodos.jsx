			...
			<div className="flex-container">
				<div className="col-5">
					<div className="register--information">
						...
						<p className="t-center blue">Paso 2: Información económica</p>
						<ul className="register--steps-number">
							...
							<li className="register-step"><a className="register-step--link active" href={null} role="button" to="pnpasodos">2</a></li>
