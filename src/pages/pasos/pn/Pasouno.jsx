					...
					<div className="col-5">
						<div className="register--information">
							...
							<ul className="register--steps-number">
								<li className="register-step"><a className="register-step--link active" href={null} role="button" to="pnpasouno">1</a></li>
								<li className="register-step"><a className="register-step--link" href={null} role="button" to="pnpasodos">2</a></li>
								<li className="register-step"><a className="register-step--link" href={null} role="button" to="pnpasotres">3</a></li>
							...
							<div className="register--form--wrapper">
								<div >
									...
									<textarea
										...
										className="register--input"
										value={
											(this.state.resident_us_description && this.state.resident_us_description !== '') ?
											this.state.resident_us_description :
											''
										}
							...
							<div className="register--form-d-flex">
								<div className="register--form--buttons">
									...
									<Link 
										...
										to="/pnpasodos"
										className={`btn btn-next ${this.state.step >= this.state.active_step ? "disabled-link" : ""}`}>Siguiente</Link>
								</div>
							</div>
						</form>
					</div>
