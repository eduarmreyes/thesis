...
class General extends Component{
	constructor(props){
		...
		this.state = {
			...
			page:'perfil',
			menu:'',
			nombre: this.props.info_cuenta !== null ? this.props.infouser['firstname'] : '',
			nombre_completo:this.props.info_cuenta !== null ? this.props.infouser['firstname'] +' '+ this.props.infouser['lastname'] : '',
			
			telefono:this.props.info_cuenta !== null ? this.props.infouser['telephone'] : '',
			movil:this.props.info_cuenta !== null ? this.props.infouser['mobilephone'] : '',
			direccion:this.props.info_cuenta !== null ? this.props.infouser['address'] : '',
			puntosforex:this.props.info_cuenta !== null ? this.props.infouser['fxpoints'] : '',
			nombre_banco:this.props.info_cuenta !== null ? this.props.infouser['bank_name'] : '',

			pais_banco:this.props.info_cuenta !== null ? this.props.infouser['bank_country'] : '',
			numero_cuenta:this.props.info_cuenta !== null ? this.props.infouser['bank_account'] : '',
			fecha_nacimiento:this.props.info_cuenta !== null ? this.props.infouser['birthday'] : '',
			fecha_iniciocontrato:null,
			fecha_finalizacioncontrato:null,
			referred_by:this.props.info_cuenta !== null ? this.props.infouser['referred_by'] : '',
			empresa_nombre:this.props.info_cuenta !== null ? this.props.infouser['enterprise_name'] : '',
			empresa_telefono:this.props.info_cuenta !== null ? this.props.infouser['enterprise_telefone'] : '',
			empresa_movil:this.props.info_cuenta !== null ? this.props.infouser['enterprise_mobilephone'] : '',
			empresa_direccion:this.props.info_cuenta !== null ? this.props.infouser['enterprise_address'] : '',
			count_account:'',
			redirect:false
