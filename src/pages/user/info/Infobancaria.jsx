...
class Infobancaria extends Component{
    ...
    set_data(){
    	this.setState({
			...
			telephone_bank:this.props.infouser['telephone_bank'],
			address_bank:this.props.infouser['address_bank'],
			swift:this.props.infouser['swift'],
			iba:this.props.infouser['iba'],
			aba:this.props.infouser['aba'],
		});
    }
    validate(){
    	this.set_data()
