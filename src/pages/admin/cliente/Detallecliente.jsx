                ...
                .then(jsonresponse => {
                    ...
                    content = jsonresponse.data.map((lista, index) => {
                        return (
                            <tr key={index}>
                                <td>
                                    {lista.code === null || lista.code === '' || lista.code === ' '
                                        ? 'N/A'
                                        : lista.code}
                                </td>
                                ...
                                <td>
                                    {' '}
                                    {lista.trans_gaining === true ? 'Ganada' : ''}
                                    {lista.trans_deposit === true ? 'Deposito' : ''}
                                    {lista.trans_initial === true ? 'Inicial' : ''}{' '}
                                    {lista.trans_lost === true ? 'Perdida' : ''}{' '}
                                    {lista.trans_retirement === true ? 'Retiro' : ''}
                                </td>
                ...
                <div className="page-cliente-empty none-margin">
                    ...
                    <div className="row-card ">
                        <div className="card-detail-col">
                            ...
                            <strong className="whiteblue">{this.state.total_debits}</strong>
                        </div>
                        <div className="card-detail-col">
                            <span>Rendimiento Historico</span>{' '}
                            <strong className="whiteblue">{this.state.account_performance}</strong>
                        </div>
                        <div className="card-detail-col">
                            <span>Rendimiento actual</span>{' '}
                            <strong className="purple">{this.state.current_performance}</strong>
                        </div>
                    </div>
                    <br />
