...
class General extends Component{
	...
	get_projects(page,per_page) {
        ...
        content = response.map((lista, index) => {
        	if (lista.projectName === '') {return false}
        	return (
						<tr key={index} className="no-cursorpointer">
							...
							<td className="actions min-width">
								<div className="button-group">
									<a className="button" href="#" onClick={e => {this.update_indicator(e,lista.id)}} >Actualizar Indicadores</a>
								</div>
								<br />
								<div className="button-group">
									<a className="button" href="#" onClick={e => {this.select_project(e,lista.id)}} >Editar</a>
								</div>
							</td>
						</tr>         
					);
