      ...
      <div className="page-empty">
        <div className="page-empty-content">
          ...
          <form className="border-radius-bottom border-0top" onSubmit={this.onSubmit}>
            ...
            <div className="form-group">
              <label className="label-gray-color">Nombre</label>
              <input
                type="text"
                name="name"
                className="form-control"
            ...
            <div className="form-group">
              <label className="label-gray-color">Correo electrónico</label>
              <input
                type="email"
                name="email"
                className="form-control"
            ...
            <div className="form-group">
              <label className="label-gray-color">Confirmar Contraseña</label>
              <input
                type="password"
            ...
            <div className="form-group form-group-button">
              <button
                type="submit"
                className="button button-radius button-primary-width button button-primary button-center"
              >
                Registrar
              </button>
            </div>
