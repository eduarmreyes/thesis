    ...
    return (
      <div className="toolbar">
        <div className="toolbar-inner">
                  ...
                  <div className="popup-deposito">
                    ...
                    <div className="form-group">
                      <input
                        ...
                        id="pip"
                        name="pip"
                        placeholder="Agregar nuevo PIPs"
                        onChange={this.onChange}
                      />
                    </div>
                    <div className="form-group msj">{this.state.msj}</div>
                    <div className="form-group">
                      <br />
                    </div>
                    <div className="form-group section-btn">
                      <button type="submit" className="blue btn" href="">
                        {' '}
                        ACEPTAR
                      </button>
                    </div>
          ...
          <div
            id="Retiro"
            className={`overlay ${this.state.overlayretiro === true ? 'overlay_visible' : ''}`}
          >
            <div className="popup">
              <div className="popup-title">
                <h4>Generar Retiro</h4> <hr />{' '}
                <a
                  role="button"
                  className="close"
                  href={null}
                  onClick={this.close_overlay_retirement}
                >
                  x
                </a>
              </div>
              <div className="popup-body">
                <div className="popup-retiro">
                  <p>
                    Usted esta genarando un retiro de la cuenta{' '}
                    {this.props.scope === 'admin' ? '' : this.props.info_cuenta['code']}
                  </p>
                  <div className="form-group">
                    <br />
                  </div>
                  <div className="form-group">
                    ...
                    >
                      <input
                        type="text"
                        value={this.state.trans_date.format('YYYY-MM-DD')}
                        readOnly
                      />
                    </DatetimePickerTrigger>
                  </div>
                  <div className="form-group">
                    <NumberFormat
                      ...
                      className={`form-control ${this.state.errortwored === true ? 'error' : ''}`}
                  ...
                  <div className="form-group section-btn">
                    <a
                      ...
                      href={null}
                      role="button"
                      onClick={this.validate_retirement}
                    >
                      {' '}
                      Aceptar
                    </a>
          ...
          <div
            id="addretiroconfirm"
            className={`overlay ${
              this.state.overlayretiro_confirm === true ? 'overlay_visible' : ''
            }`}
          >
            <div className="popup">
              <div className="popup-title">
              ...
              <div className="popup-body">
                <p>¿Esta seguro que desea aplicar la transacción ?</p>
                <div className="popup-retiro">
                  <div className="form-group section-btn">
                    <a
                      className="close blue btn"
                      href={null}
                      role="button"
                      onClick={this.close_overlay_retirement_confirm}
                    >
                      CANCELAR
                    </a>{' '}
                    <a
          ...
          <div
            id="Deposito"
            className={`overlay ${this.state.overlaydeposito === true ? 'overlay_visible' : ''}`}
          >
            <div className="popup">
              <div className="popup-title">
                <h4>Generar aumento de Capital</h4> <hr />{' '}
                <a className="close" href={null} role="button" onClick={this.close_overlay_deposit}>
                  x
                </a>
              </div>
              <div className="popup-body">
                <div className="popup-retiro">
                  <p>
                    Usted esta abonando a la cuenta{' '}
                    {this.props.scope === 'admin' ? '' : this.props.info_cuenta['code']}
                  </p>
                  <div className="form-group">
                    <br />
                  ...
                  <div className="form-group">
                    ...
                    >
                      <input
                        type="text"
                        value={this.state.trans_date_deposito.format('YYYY-MM-DD')}
                        readOnly
                      />
                    </DatetimePickerTrigger>
                  </div>
                  <div className="form-group">
                    <NumberFormat
                      ...
                      className={`form-control ${this.state.errortwored === true ? 'error' : ''}`}
                      value={this.state.amount_deposito}
                      thousandSeparator={true}
                      prefix={'$'}
                      decimalSeparator={'.'}
                      decimalScale={2}
          ...
          <div
            id="addretiroconfirm"
            className={`overlay ${
              this.state.overlaydeposito_confirm === true ? 'overlay_visible' : ''
            }`}
          >
            <div className="popup">
              <div className="popup-title">
                ...
                <div className="popup-retiro">
                  <div className="form-group section-btn">
                    <a
                      ...
                      href={null}
                      role="button"
                      onClick={this.close_overlay_deposit_confirm}
                    >
                      CANCELAR
                    </a>{' '}
                    <a
          ...
          <div
            id="Referir"
            className={`overlay ${this.state.overlayreferir === true ? 'overlay_visible' : ''}`}
          >
            <div className="popup">
              <div className="popup-title">
                <h4>Referir nuevo usuario</h4> <hr />{' '}
                <a className="close" href={null} role="button" onClick={this.close_overlay_referir}>
                  x
                </a>
              </div>
              <div className="popup-body">
                <div className="popup-retiro">
                  ...
                  <div className="form-group">
                    <input
                      type="text"
                      className={`form-control ${this.state.erroroneref === true ? 'error' : ''}`}
                      id="name"
                      name="name"
                  ...
                  <div className="form-group">
                    <input
                      type="text"
                      className={`form-control ${this.state.errortworef === true ? 'error' : ''}`}
                      id="email"
                      name="email"
                  ...
                  <div className="form-group">
                    <input
                      type="text"
                      className={`form-control ${this.state.errorthreref === true ? 'error' : ''}`}
                      id="telephone"
                      name="telephone"
                  ...
                  <div className="form-group section-btn">
                    <a className="blue btn" href={null} onClick={this.validate_referir}>
                      {' '}
                      Aceptar
                    </a>
                  </div>
          ...
          <div
            id="changuepass"
            className={`overlay ${
              this.state.overlayreferir_confirm === true ? 'overlay_visible' : ''
            }`}
          >
            <div className="popup">
              <div className="popup-title">
              ...
              <div className="popup-body">
                <p>¿Esta seguro que desea referir a {this.state.name} ?</p>
                <div className="popup-retiro">
                  <div className="form-group section-btn">
                    <a
                      role="button"
